...
- Domácí ukoly jsou většinou hodnoceny 10 body bez ohledu na obtížnost.  V každé trojici se snažím zadávat jednu těžší úlohu, aby si pokročilejší Pythonisté mohli vyzkoušet svaly. 
...
1. **Základní distribuce Pythonu**
   ...
   Zvolte si nejnovější verzi 3.12.6. Součástí instalace je vlastní interpret a jednoduché IDE _Idle_. S tímto klidně vystačíte pro celý kurz, ale pro následující semestr už budete chtít pracovat v nějakém vyspělejším prostředí.
